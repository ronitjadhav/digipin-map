        ...
        <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8 text-gray-900 pt-20">
            ...
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-8">
                <div className="flex-1 p-6 rounded-lg shadow-md dark:bg-gray-900 min-w-[300px]">
                    ...
                    <p className="text-lg mb-4 dark:text-gray-300">
                        For more information, visit the <a href="https://www.indiapost.gov.in/vas/Pages/digipin.aspx"
...
`}
                    ...
                    <p className="text-lg mb-4 dark:text-gray-300">
                        Contributions are welcome! Please <a href="https://github.com/ronitjadhav/digipin-geocode" className="text-blue-600 dark:text-blue-400 hover:underline" target="_blank">fork
                        the repository</a> and submit pull requests. For major changes, please open an issue first to discuss what you would like to change.
                    </p>
                    <h3 className="text-2xl font-bold mb-4 dark:text-white">License</h3>
                    <p className="text-lg mb-4 dark:text-gray-300">
                        This project is licensed under the MIT License. See the <a href="https://github.com/ronitjadhav/digipin-geocode/blob/main/LICENSE" className="text-blue-600 dark:text-blue-400 hover:underline" target="_blank">LICENSE</a> file for details.
                    </p>
                </div>
            </div>
        </div>
