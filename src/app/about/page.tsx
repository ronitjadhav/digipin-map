                ...
                <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-8">
                    <div className="flex-1 p-6 rounded-lg shadow-md dark:bg-zinc-800 min-w-[300px]">
                        ...
                        <p className="text-lg mb-4 dark:text-gray-300">
                            ...
                            standardized,
                            geo-coded addressing system in India, ensuring simplified addressing solutions for
                            citizen-centric delivery of public and private services. This initiative is named
                            the <strong>Digital
                            Postal Index Number (DIGIPIN)</strong>.
                        </p>
                        <p className="text-lg mb-4 dark:text-gray-300">
                            The Department has collaborated with <strong>IIT Hyderabad</strong> to develop a National
                            Level
                            Addressing Grid-based system. DIGIPIN divides India&apos;s geographical territory into
                            uniform
                            4-meter by 4-meter units, assigning each a unique 10-digit alphanumeric code derived from
                            the
                            latitude and longitude coordinates of the unit.
                        </p>
                        <p className="text-lg mb-4 dark:text-gray-300">
                            This system will act as a strong and robust pillar of Geospatial Governance, enhancing
                            public
                        ...
                        <p className="text-lg mb-4 dark:text-gray-300">
                            The Department is releasing a beta version of the National Level Addressing Grid ‘DIGIPIN’
                            for
                            public feedback. Industry leaders, technical institutes, state and local governments, and
                            the
                        ...
                        <p className="text-lg mb-4 dark:text-gray-300">
                            ...
                            className="text-blue-600 dark:text-blue-400 hover:underline">India
                            Post DIGIPIN page</a>.
                        </p>
                        <h2 className="text-2xl font-bold mb-4 dark:text-white">Credits</h2>
                        <p className="text-lg mb-4 dark:text-gray-300">
                            The Digipin project is developed in collaboration with the Department of Posts and IIT
                            Hyderabad.
                        </p>
                        <hr className="my-4 border-gray-300 dark:border-gray-700"/>
                        <p className="text-s dark:text-gray-500">
                    ...
                    <div className="flex-1 p-6 rounded-lg shadow-md bg-white dark:bg-zinc-800 min-w-[300px]">
                        <h2 className="text-3xl font-bold text-center mb-8 dark:text-white">Want to Implement DIGIPIN in
                            Your Project?</h2>
                        <p className="text-lg mb-4 dark:text-gray-300">
...
`}
                        ...
                        <h3 className="text-2xl font-bold mb-4 dark:text-white">Contributing</h3>
                        <p className="text-lg mb-4 dark:text-gray-300">
                            Contributions are welcome! Please <a href="https://github.com/ronitjadhav/digipin-geocode"
                                                                 className="text-blue-600 dark:text-blue-400 hover:underline"
                                                                 target="_blank">fork
                            the repository</a> and submit pull requests. For major changes, please open an issue first
                            to discuss what you would like to change.
                        </p>
                        <h3 className="text-2xl font-bold mb-4 dark:text-white">License</h3>
                        <p className="text-lg mb-4 dark:text-gray-300">
